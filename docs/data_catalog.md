...
The Gold layer is the business-level data representation, structured to support analytical and reporting use case. It consist of **dimension tables** and **fact tables** for specific business metrics
